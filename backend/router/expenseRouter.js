...
import { askController, deleteExp, expenseAndIncome, expenseController, getAll, getExpense, getIncome } from "../controller/expenseController.js";
...
expenseRouter.put("/delete/:id",deleteExp);